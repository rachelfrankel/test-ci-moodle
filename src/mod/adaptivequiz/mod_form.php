...
class mod_adaptivequiz_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('select', 'browsertimer', get_string('browsertimer', 'adaptivequiz'), $options);
        $mform->addHelpButton('browsertimer', 'browsertimer', 'adaptivequiz');
        $mform->setDefault('browsertimer', 0);
        
        $mform->addElement('text', 'timeInput', get_string('timeInput', 'adaptivequiz'),    ['size' => '5', 'maxlength' => '5']);
        $mform->addHelpButton('timeInput', 'timeInput', 'adaptivequiz');
        $mform->addRule('timeInput', get_string('formelementtimeempty', 'adaptivequiz'), 'required', null, 'client');
        $mform->addRule('timeInput', get_string('formattime', 'adaptivequiz'), 'time', null, 'client');
        $mform->setType('timeInput', PARAM_TEXT); 
        $mform->hideIf('timeInput', 'browsertimer', 'neq', 1);
        ...
        $mform->addElement('text', 'startinglevel', get_string('startinglevel', 'adaptivequiz'),    ['size' => '3', 'maxlength' => '3']);
