...
$string['browsertimer'] = 'Timer';
$string['browsertimer_help'] ="Option to limit the amount of time a student can perform the adaptive quiz attempt.";
$string['timeinput'] = 'Time';
$string['timeinput_help'] ="The maximum duration of time to make an adaptive quiz attempt.";
...
$string['formattime'] = 'Input a string in format HH:MM';
